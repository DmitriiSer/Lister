(function () {
    ...
    /*global angular, ionic, window, location, navigator*/
    /* services */
    angular.module("app.services", [])
            ...
            .service("browser", ["$window", function ($window) {
                    return {
                        name: function () {
                            var userAgent, browsers, key, i;
                            userAgent = $window.navigator.userAgent.toLowerCase();
                            browsers = {
                                ie: ["trident", "ie", "internet explorer"],
                                firefox: ["firefox"],
                                opera: ["opr", "opera"],
                                chrome: ["chrome"],
                                safari: ["safari"]
                            ...
                            for (key in browsers) {
                                if (browsers.hasOwnProperty(key)) {
                                    //console.log("key = " + key + ", value = " + browsers[key] + ", value_len = " + browsers[key].length);
                                    for (i = 0; i < browsers[key].length; i++) {
                                        if (userAgent.indexOf(browsers[key][i]) !== -1) {
                                            return key;
                                        }
                                    }
            ...
            .factory("session", ["$interval", function ($interval) {
                    var service = {
                        ...
                        getAvatar: function () {
                            return service.userProfile.avatar;
                        },
                        isLoggedIn: function () {
